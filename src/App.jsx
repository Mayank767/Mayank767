...
export const TOOLS = [
  // Text & String
  { id: 'base64', name: 'Base64 Encode/Decode', desc: 'Securely convert text to Base64 and back locally in your browser. 100% private.', seoTitle: 'Base64 Encoder Decoder Online Free | ZeroApiTools', seoDesc: 'Securely convert text to Base64 and back locally in your browser. 100% private. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '🔤', category: 'text', component: Base64Tool, sample: 'Hello, World! 🌍' },
  ...
  { id: 'jwt-decoder', name: 'JWT Decoder', desc: 'Decode JWT tokens offline. Header, payload & expiry. No server upload.', seoTitle: 'JWT Token Decoder Online — Read JWT Payload Free | ZeroApiTools', seoDesc: 'Decode JWT tokens offline. Header, payload & expiry. No server upload. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '🎟️', category: 'text', component: JwtDecoder, sample: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c' },
  { id: 'uuid', name: 'UUID Generator', desc: 'Generate random v4 UUIDs in bulk', seoTitle: 'UUID Generator Online Free | ZeroApiTools', seoDesc: 'Generate random v4 UUIDs in bulk. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '🆔', category: 'text', component: UuidGenerator, sample: '5' },
  ...
  { id: 'diff-checker', name: 'Text Diff Checker', desc: 'Compare two texts and highlight differences', seoTitle: 'Text Diff Checker Online Free | ZeroApiTools', seoDesc: 'Compare two texts and highlight differences. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '📊', category: 'text', component: DiffChecker, sample: 'The quick brown fox\njumps over the lazy dog\nHello World' },
  { id: 'regex-tester', name: 'Regex Tester', desc: 'Test regular expressions with live match highlighting', seoTitle: 'Regex Tester Online — Test Regular Expressions Free | ZeroApiTools', seoDesc: 'Test regular expressions with live match highlighting. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '🔍', category: 'text', component: RegexTester, sample: 'hello@example.com, test@gmail.com, invalid-email' },

  // Code Formatters
  { id: 'json-formatter', name: 'JSON Formatter & Validator', desc: 'Beautify, minify & validate JSON data', seoTitle: 'JSON Formatter & Validator Online Free | ZeroApiTools', seoDesc: 'Beautify, minify & validate JSON data. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '{ }', category: 'code', component: JsonFormatter, sample: '{"name":"John","age":30,"city":"Mumbai","skills":["JS","React","Node"]}' },
  { id: 'js-beautifier', name: 'JS Beautifier / Minifier', desc: 'Format or compress JavaScript code', seoTitle: 'JS Beautifier / Minifier Online Free | ZeroApiTools', seoDesc: 'Format or compress JavaScript code. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '⚡', category: 'code', component: JsBeautifier },
  { id: 'css-beautifier', name: 'CSS Beautifier / Minifier', desc: 'Format or compress CSS stylesheets', seoTitle: 'CSS Beautifier / Minifier Online Free | ZeroApiTools', seoDesc: 'Format or compress CSS stylesheets. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '🎨', category: 'code', component: CssBeautifier },
  { id: 'html-beautifier', name: 'HTML Beautifier / Minifier', desc: 'Format or compress HTML markup', seoTitle: 'HTML Beautifier / Minifier Online Free | ZeroApiTools', seoDesc: 'Format or compress HTML markup. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '🌐', category: 'code', component: HtmlBeautifier },
  ...
  { id: 'markdown-preview', name: 'Markdown Preview', desc: 'Write Markdown and see live rendered output', seoTitle: 'Markdown Preview Online — Live Editor Free | ZeroApiTools', seoDesc: 'Write Markdown and see live rendered output. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '📑', category: 'converter', component: MarkdownPreview },
  ...
  { id: 'gradient', name: 'Gradient Generator', desc: 'Build linear & radial gradients visually', seoTitle: 'CSS Gradient Generator Online Free | ZeroApiTools', seoDesc: 'Build linear & radial gradients visually. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '🌈', category: 'css', component: GradientGenerator },
  { id: 'box-shadow', name: 'Box Shadow Generator', desc: 'Design box shadows with visual editor', seoTitle: 'CSS Box Shadow Generator Online Free | ZeroApiTools', seoDesc: 'Design box shadows with visual editor. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '🔲', category: 'css', component: BoxShadowGen },
  ...
  { id: 'flexbox', name: 'Flexbox Playground', desc: 'Experiment with flexbox properties visually', seoTitle: 'CSS Flexbox Generator Online Free | ZeroApiTools', seoDesc: 'Experiment with flexbox properties visually. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '📦', category: 'css', component: FlexboxPlayground },
  ...
  // Image Tools
  { id: 'image-compress', name: 'Image Compressor', desc: 'Compress & convert images to WebP locally in your browser without uploading to a server.', seoTitle: 'Image Compressor Online Free — No Upload | ZeroApiTools', seoDesc: 'Compress & convert images to WebP locally in your browser without uploading to a server. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '🗜️', category: 'image', component: ImageCompressor },
  ...
  // Security
  { id: 'password-gen', name: 'Password Generator', desc: 'Generate strong, secure passwords locally. Your passwords never leave your device.', seoTitle: 'Strong Password Generator Online Free | ZeroApiTools', seoDesc: 'Generate strong, secure passwords locally. Your passwords never leave your device. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '🔐', category: 'security', component: PasswordGenerator },
  ...
  // Unique Tools
  { id: 'curl-to-fetch', name: 'cURL → Fetch Converter', desc: 'Convert cURL commands to JS fetch() or axios', seoTitle: 'cURL to Fetch Converter Online Free | ZeroApiTools', seoDesc: 'Convert cURL commands to JS fetch() or axios. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '🔁', category: 'unique', component: CurlToFetch, sample: "curl -X POST https://api.example.com/users -H 'Content-Type: application/json' -d '{\"name\":\"John\"}'" },
  { id: 'cron-parser', name: 'Cron Expression Parser', desc: 'Decode cron schedules in plain English + next runs', seoTitle: 'Cron Expression Parser & Tester Online Free | ZeroApiTools', seoDesc: 'Decode cron schedules in plain English + next runs. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '⏱️', category: 'unique', component: CronParser, sample: '0 9 * * 1-5' },
  ...
  { id: 'chmod-calc', name: 'Chmod Calculator', desc: 'Visual Linux file permissions calculator', seoTitle: 'Chmod Calculator Online — Linux Permissions Free | ZeroApiTools', seoDesc: 'Visual Linux file permissions calculator. Free online tool, no signup required, works in browser. | ZeroApiTools', icon: '🔒', category: 'unique', component: ChmodCalculator },
