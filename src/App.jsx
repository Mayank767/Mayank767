...
export const TOOLS = [
  ...
  { id: 'cron-parser', name: 'Cron Expression Parser', desc: 'Decode cron schedules in plain English + next runs', seoTitle: 'Cron Expression Generator & Parser Online Free | ZeroApiTools', seoDesc: 'Free cron expression generator & tester online. Decode cron schedules to plain English and see next run times instantly. No signup, works in browser. | ZeroApiTools', icon: '⏱️', category: 'unique', component: CronParser, sample: '0 9 * * 1-5' },
